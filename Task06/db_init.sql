CREATE TABLE IF NOT EXISTS employees (
    ...
    name TEXT NOT NULL,
    position TEXT NOT NULL CHECK(position IN ('master', 'admin', 'manager')),
...
-- Сотрудники
INSERT OR IGNORE INTO employees (name, position, salary_percentage, hire_date, dismissal_date, phone, email) VALUES
('Иванов Иван Иванович', 'master', 25.0, '2023-01-15', NULL, '+7-900-123-45-67', 'ivanov@example.com'),
('Петров Петр Петрович', 'master', 30.0, '2023-02-01', NULL, '+7-900-234-56-78', 'petrov@example.com'),
('Сидорова Мария Сергеевна', 'master', 28.0, '2023-03-10', NULL, '+7-900-345-67-89', 'sidorova@example.com'),
('Козлов Алексей Викторович', 'master', 27.0, '2022-11-20', '2024-06-30', '+7-900-456-78-90', 'kozlov@example.com'),
('Смирнова Анна Дмитриевна', 'admin', 0.0, '2023-01-05', NULL, '+7-900-567-89-01', 'smirnova@example.com'),
('Волков Дмитрий Александрович', 'manager', 0.0, '2023-04-01', NULL, '+7-900-678-90-12', 'volkov@example.com');

-- Категории автомобилей
INSERT OR IGNORE INTO car_categories (name, description) VALUES
...
-- Боксы
INSERT OR IGNORE INTO boxes (number, is_active, description) VALUES
...
-- Услуги
-- Легковые
INSERT OR IGNORE INTO services (name, duration_minutes, price, car_category_id, description) VALUES
...
INSERT OR IGNORE INTO bookings (client_name, client_phone, box_id, employee_id, service_id, booking_date, booking_time, status, notes) VALUES
...
-- Выполненные работы
INSERT OR IGNORE INTO completed_works (booking_id, employee_id, box_id, service_id, work_date, work_time, actual_duration_minutes, actual_price, notes) VALUES
