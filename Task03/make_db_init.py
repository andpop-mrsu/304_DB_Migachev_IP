...
def generate_sql_script():
    ...
    with open('dataset/movies.csv', mode='r', encoding='utf-8') as file:  
    ...
    with open('dataset/ratings.csv', mode='r', encoding='utf-8') as file:  
        csv_reader = csv.reader(file)
        next(csv_reader)
        for row in csv_reader:
    ...
    with open('dataset/tags.csv', mode='r', encoding='utf-8') as file:  
        csv_reader = csv.reader(file)
        next(csv_reader)
        for row in csv_reader:
    ...
    with open('dataset/users.txt', mode='r', encoding='utf-8') as file:
